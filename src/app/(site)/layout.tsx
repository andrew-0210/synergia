...
import "../globals.css";
import { gilroy, bricolage, manrope } from "../fonts/font";
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${gilroy.variable} ${bricolage.variable} ${manrope.variable} antialiased selection:bg-[#c6fe4e] selection:text-[#1e1e1e]`}
      >
        <Nav />
        {children}
        <Analytics />
